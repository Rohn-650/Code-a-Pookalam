...
def draw_pookkalam():
    ...
    draw_circle(300, "#4B0082")  # Outer dark purple ring
    draw_circle(280, "#8B4513")  # Brown base
    draw_circle(260, "#FFD700")  # Golden ring
    draw_circle(240, "#8B0000")  # Dark red ring
    # Draw the main flower
    draw_flower(12, 280, 240, "#FF4500", "#FFFF00")  # Orange and yellow flower
    
    # Draw inner circles
    draw_circle(200, "#006400")  # Dark green ring
    draw_circle(180, "#FF564F")  # White ring
    
    # Draw diamond patterns
    draw_diamonds(12, 180, 20, "#9F6347")  # Red diamonds
    
    # Draw center flower
    draw_flower(24, 180, 110, "#1F6700", "#6FD700")  # Red and golden flower
